...
declare variable $title := 'Retrieve subset of sentences without participles - Complexity in Ancient Greek sentence';
declare variable $content := "Retrieve a subset from the Ancient Greek treebank set, based on number of words, without participles";
declare variable $keywords := "Greek language, treebanks, syntax, participle";
declare variable $subtitle := "Retrieve a subset from the Ancient Greek treebank set, based on number of words, without participles";

(:~
 : This function returns an XML response message.
 :)
declare
  %rest:path("grccom-subset-sent-no-ptc/{$from}/{$to}")
  %output:method(
  "html"
)
  %output:html-version(
  ...
  function page:greekcomplexitysubsetnoptc($from, $to)
{
...
<p>The table is scrollable, click on a row and then use arrows to scroll right or left.</p>
	{ grccom:showsubsetnoptcp( $from, $to ) }
</div>
</div>
<hr/>
{ grccom:footerserver() }
